...
import com.example.ejerciciodeprogramacinorientadaaobjetospoo.classes.Computer
...
class TabletActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val options = State.entries.map { it.name } // Obtener los nombres de todas las opciones de la enum class
        ...
        val myDevices = Devices("", "", State.NEW, "",
            AttributesComputer("","","",""))
        fun agregarCelu( brand : String, model : String, state : State, id : String, ram : AttributesComputer,
        )
        {
